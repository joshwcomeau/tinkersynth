...
const SlopesIndex = () => (
  <LayoutSidePage title="Frequently Asked Questions">
    <QuestionAndAnswer id="what-is-this" question="Er, so, what is this?">
      ...
      <Paragraph>
        Generative art is an umbrella term for art created by writing software
        that generates it. In this case, I wrote code that uses Perlin noise and
        trigonometry to create sloped lines.
      </Paragraph>

      <Paragraph>
        The code for this project has parameters that can be tweaked. Initially
        these parameters were pretty straightforward, things like the distance
        between each line... but I kept having ideas for alternative ways that
        the code could work, and as the number of parameters grew, the number of
        possible combinations exploded.
      </Paragraph>

      <Paragraph>
        I started to realize that this wasn't just making small tweaks to a
        generally consistent experience anymore; entirely different pieces of
        art could be created, by experimenting with different combinations. This
        is a hyper-specialized Photoshop; it's a tool to create, not just subtly
        alter.
      </Paragraph>
      ...
      <Paragraph>
        ...
        mechanism I'm using to fund the time I invested creating this tool. If
        it does well, that'll encourage me to create new machines, with
