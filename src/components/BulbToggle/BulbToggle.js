...
const BulbToggle = ({ size = 38, enableDarkMode, toggleDarkMode }) => {
    ...
    >
      <Svg width={size - 6} height={size - 2} viewBox="0 0 32 29" fill="none">
        <path
          ...
          stroke="#FFFBDA"
          strokeOpacity={enableDarkMode ? 0 : 0.5}
          strokeWidth="0.5"
          strokeLinecap="round"
        ...
        <path
          ...
          stroke={enableDarkMode ? COLORS.gray[700] : COLORS.yellow[300]}
          strokeWidth="2"
        />
        <path
          data-layer-name="Base"
          d="M12 23H20M12 24.6667H20M13.1089 26.3333H18.9703M14.7723 28H16.9109"
          stroke={enableDarkMode ? COLORS.gray[700] : COLORS.gray[300]}
        />
        <g
          data-layer-name="Beams"
          style={{ display: enableDarkMode ? 'none' : 'block' }}
        >
          <path
            d="M27 10H31"
            stroke="#FFEB33"
