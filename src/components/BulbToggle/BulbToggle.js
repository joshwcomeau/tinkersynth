...
const BulbToggle = ({ size = 38, isDarkMode, toggleDarkMode }) => {
    ...
    >
      ...
      >
        <path
          ...
          stroke="#FFFBDA"
          strokeOpacity={isDarkMode ? 0 : 0.5}
          strokeWidth="0.5"
          strokeLinecap="round"
        ...
        <path
          ...
          stroke={isDarkMode ? COLORS.gray[700] : COLORS.yellow[300]}
          strokeWidth="2"
        />
        <path
          data-layer-name="Base"
          d="M12 23H20M12 24.6667H20M13.1089 26.3333H18.9703M14.7723 28H16.9109"
          stroke={isDarkMode ? COLORS.gray[700] : COLORS.gray[300]}
        />
        <g
