...
import { useAppStateOptional } from '../../context/AppStateContext';
...
const Slider = ({
  ...
  const isMachineBroken = appState?.machineHasBeenBroken ?? false;
  const breakMachineWithKeyboard =
    appState?.breakMachineWithKeyboard ?? (() => {});
